      ...
      <div className="max-w-5xl mx-auto px-4 py-4 flex items-center justify-between">
        <Link href="/">
          <div className="flex items-center">
            ...
            <span className="text-2xl font-bold text-white hover:text-gray-200 transition-colors">MovieSuggester</span>
          </div>
        </Link>
        <nav>
          <Link href="https://openai.com" target="_blank" rel="noreferrer" className="hidden md:inline">
            <span className="text-white hover:text-gray-200 transition-colors">Powered by OpenAI</span>
          </Link>
        </nav>
      </div>
    </header>
